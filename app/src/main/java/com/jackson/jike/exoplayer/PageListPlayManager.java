 ...
 * FileName: PageListPlayManager
 * Author: Luo
 * Date: 2020/5/9 13:11
 * Description:能适应多个页面视频播放的 播放器管理者,每个页面一个播放器,方便管理每个页面的暂停/恢复操作
 */
public class PageListPlayManager {

    //存储每一个页面对应的PageListPlay对象
    ...
    public static void release(String pageName) {
        PageListPlay pageListPlay = mPageListPlayHashMap.remove(pageName);
        if (pageListPlay != null) {
