 ...
 * FileName: CameraXPreviewView
 * Author: Luo
 * Date: 2020/6/9 17:09
 * Description: 自定义CameraX PreviewView ，实现对焦、缩放 等功能
 */
...
//    };
    ...
    GestureDetector.OnGestureListener onGestureListener = new GestureDetector.OnGestureListener() {
        ...
        public void onShowPress(MotionEvent e) {
            KLog.i("onShowPress: 刚碰上还没松开");
        }

        @Override
        public boolean onSingleTapUp(MotionEvent e) {
            KLog.i("onSingleTapUp: 轻轻一碰后马上松开");
            return true;
        }

        @Override
        public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
            KLog.i("onScroll: 按下后拖动");
            // 大于两个触摸点
    ...
    GestureDetector.OnDoubleTapListener onDoubleTapListener = new GestureDetector.OnDoubleTapListener() {
        ...
        public boolean onSingleTapConfirmed(MotionEvent e) {
            KLog.i("onSingleTapConfirmed: 严格的单击");
            if (mCustomTouchListener != null) {
        ...
        public boolean onDoubleTapEvent(MotionEvent e) {
            KLog.i("onDoubleTapEvent: 表示发生双击行为");
            return true;
        }
    };
}
